...
- Retire stale continuous-move watchdog state when absolute, relative, or preset movement supersedes it, and dispatch shutdown Stops independently per camera with bounded waiting.
